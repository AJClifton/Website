  ...
  return (
    <div className="bg-zinc-100 dark:bg-zinc-800 grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <h1 className="text-grey-500 dark:text-white text-3xl font-bold tracking-wider text-center content-stretch"><TypeEffect text="> AJClifton" delay={300} startingIndex={2} initialDelay={1000}/><Cursor blinks={10} blinkTime={530} /></h1>
